...
| `name <name>`                              | Hub name for health checks and metrics. Hubs in one process share a transport only when their names match; give each independent hub its own.               | `default`                       |
