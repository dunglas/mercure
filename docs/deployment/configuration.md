...
| `name <name>`                              | Hub name for health checks, metrics, and transport sharing. Equal names share a transport; at most one hub per configuration may omit its name.             | `default`                       |
