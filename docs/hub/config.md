...
| `cookie_name <name>`                                       | the name of the cookie to use for the authorization mechanism                                                                                                                                                                                                                                                                                                        | `mercureAccessToken` |
| `public_url <url>`                                         | the URL at which subscribers reach the hub, used as the base URL when matching relative URL patterns and topics                                                                                                                                                                                                                                                      |                        |
| `resource_identifier <id>`                                 | the hub's OAuth 2.0 resource identifier; the audience (`aud`) access tokens must carry (RFC 9068). Required when JWT authentication is enabled in modern mode                                                                                                                                                                                                        | `public_url`           |
| `authorization_servers <url...>`                           | OAuth 2.0 authorization server issuer identifiers advertised in the hub's protected resource metadata (RFC 9728)                                                                                                                                                                                                                                                     |                        |
| `subscriptions`                                            | expose the subscription web API and dispatch private updates when a subscription between the Hub and a subscriber is established or closed. The topic follows the template `/.well-known/mercure/subscriptions/{matchType}/{match}/{subscriberID}`                                                                                                                   |                        |
...
| `protocol_version_compatibility`                           | version of the protocol to be backward compatible with (versions 7 and 8 are supported; version 8 also requires a hub binary built with the `deprecated_topic` and `deprecated_claim` tags to accept the legacy `topic` selectors and `mercure` JWT claim)                                                                                                           | disabled               |
| `demo`                                                     | enable the UI and expose demo endpoints                                                                                                                                                                                                                                                                                                                              |                        |
| `ui`                                                       | enable the UI but do not expose demo endpoints                                                                                                                                                                                                                                                                                                                       |                        |
| `topic_selector_cache <size>`                             | Maximum number of entries in the topic-matcher result cache; pass `0` or a negative value to disable the cache. The compiled-pattern caches are sized as a fraction of it.                                                                                                                                                                                                | `100000`               |
...
| `subscriptions`            | expose the subscription web API and dispatch private updates when a subscription between the Hub and a subscriber is established or closed. The topic follows the template `/.well-known/mercure/subscriptions/{matchType}/{match}/{subscriberID}`                                                                                                                                           | `false`                                                  |
