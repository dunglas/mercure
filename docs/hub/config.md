...
| `subscriptions`                        | expose the subscription web API and dispatch private updates when a subscription between the Hub and a subscriber is established or closed. The topic follows the template `/.well-known/mercure/subscriptions/{match_type}/{match}/{subscriberID}`                                                                                                                   |                        |
...
| `protocol_version_compatibility`       | version of the protocol to be backward compatible with (versions 7 and 8 are supported; version 8 also requires a hub binary built with the `deprecated_topic` tag)                                                                                                                                                                                                  | disabled               |
...
| `subscriptions`            | expose the subscription web API and dispatch private updates when a subscription between the Hub and a subscriber is established or closed. The topic follows the template `/.well-known/mercure/subscriptions/{match_type}/{match}/{subscriberID}`                                                                                                                                           | `false`                                                  |
