...
| `topic_selector_cache <maxEntriesPerShard> [<shardCount>]` | Topic Selector cache configuration (see [golang-lru docs](https://github.com/hashicorp/golang-lru))                                                                                                                                             | `10000` `256`          |
