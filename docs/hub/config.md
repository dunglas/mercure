...
| `topic_selector_cache <maxEntriesPerShard> [<shardCount>]` | Topic Selector cache configuration (pass `off` to disable the cache, and `unlimited` for an unlimited number of entries)                                                                                                                        | `10000` `256`          |
| `subscriber_list_cache_size <maxSize>`                     | Subscriber list cache size, pass `off` to disable the cache                                                                                                                                                                                     | `100000`               |
