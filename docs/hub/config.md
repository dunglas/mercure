...
| `compress`                 | Usedisable HTTP compression support                                                                                                                                                                                                                                                                                                                                                      | `false`                                                  |
...
| `metrics`                  | Enable the `/metrics` HTTP endpoint. Provide metrics for Hub monitoring in the OpenMetrics (Prometheus) format                                                                                                                                                                                                                                                                           | `false`                                                  |
| `metrics_login`            | if metrics are enabled, the login of the allowed user to access the `/metrics` endpoint, defaults to `mercure`                                                                                                                                                                                                                                                                           | `mercure`                                                |
