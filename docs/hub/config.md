...
| `topic_selector_cache <maxEntriesPerShard> [<shardCount>]` | Topic Selector cache configuration (pass a negative value to disable the cache, and 0 for an unlimited number of entries)                                                                                                                       | `10000` `256`          |
