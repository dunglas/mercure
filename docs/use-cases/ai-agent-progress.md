...
- **Reconnect resilience.** User closes the laptop mid-run, opens it again, the UI reconnects and replays the events it missed. No dropped progress.
...
- runs take long enough that users want to *see* progress, not just wait;
