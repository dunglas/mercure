...
// caddy 2.11.4 cannot build against these: cel-go 0.29.0 renamed
// interpreter.Interpretable to InterpretableV2, and automemlimit 1.0.0 removed
// memlimit.SetGoMemLimitWithOpts. Both are still used by caddy.
exclude (
